...
target_filenames = ['top1_metrics_canva.csv', 'hit5_metrics_canva.csv', 'coverage_metrics_canva.csv', 'diversity_metrics_canva.csv', 'mrr_metrics_canva.csv']

# 3. Nome del file di output
output_filename = 'summary_full_metrics_results.csv'
