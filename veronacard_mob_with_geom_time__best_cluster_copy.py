...
class Config:
    ...
    # Model configuration
    MODEL_NAME = "qwen2.5:7b" #llama3.1:8b - qwen2.5:7b - qwen2.5:14b - mixtral:8x7b - mistral:7b - deepseek-coder_33b
    ...
    RESULTS_DIR = Path(__file__).resolve().parent / "results/penultimate/qwen2.5_7b/with_geom_time_cluster/"
