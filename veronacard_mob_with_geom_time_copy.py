...
class Config:
    ...
    # Model configuration
    MODEL_NAME = "llama3.1:8b" #llama3.1:8b - qwen2.5:7b - qwen2.5:14b - mixtral:8x7b - mistral:7b
    ...
    RESULTS_DIR = Path(__file__).resolve().parent / "results/penultimate/llama3.1_8b/with_geom_time/"
